...
| **Tesseract** | $.\textcolor{red}{\text{«}}\text{ល}\textcolor{red}{\text{ខទ}}\text{ទិការដ្ឋាន}$ $\textcolor{red}{\text{ទ}}\text{ណៈក}\textcolor{red}{\text{ម្ពា}}\text{ធិការដឹក}\textcolor{red}{\text{ឆាំ}}$ | $\text{និងកែសម្រួលសមាសភាព}$ $\text{រាជ}\textcolor{red}{\text{ន្ឋា}}\text{ភិបាល}$ $\text{នៃ}\textcolor{red}{\text{ទ្រះ}}\text{រាជាណាចក្រកម្ពុជា}$ | $\textcolor{red}{\text{ទូ}}\text{បនាយករដ្ឋមន្ត្រី}$ | 180818125 |
