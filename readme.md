...
| **SeqSE-CRNN-Tr** | អគ្គលេខះ${\color{red}\text{ទិកា}}$ដ្ឋាន${\color{red}\text{ឧកណះ}}$ក${\color{red}\text{ម្ពា}}$ធិការ${\color{red}\text{ដើ}}$កនាំ | និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល${\color{red}\text{នៃ}}$ព្រះរាជាណាចក្រកម្ពុជា | ឧបនាយក${\color{red}\text{រដ្ឋ}}$មន្ត្រី | $180818{\color{red}18}125$ |
| **VGG-Tr** | អគ្គលេខ${\color{red}\text{ះទិ}}$ការដ្ឋានគណៈក${\color{red}\text{ម្ពា}}$ធិការ${\color{red}\text{ដើ}}$កនាំ | និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល${\color{red}\text{នៃ}}$ព្រះរាជាណាចក្រកម្ពុជា | ${\color{red}\text{ខ្ញុំ}}$បនាយករដ្ឋមន្ត្រី | $18081{\color{red}\vert}8125$ |
| **ResNet-Tr** | ${\color{red}\text{ភ្លេ}}$ល${\color{red}\text{ខះ}}$ធិការដ្ឋាន${\color{red}\#}$ណៈក${\color{red}\text{ម្ព}}$ដិការដឹកនាំ | និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល${\color{red}\text{នៃ}}$ព្រះរាជាណាចក្រកម្ពុជា | ឧបនាយករដ្ឋម${\color{red}\text{ន្តី}}$ | $18{\color{red}0}818125$ |
| **Tesseract** | .${\color{red}\text{«}}$ល${\color{red}\text{ខទ}}$ទិការដ្ឋាន${\color{red}\text{ទ}}$ណៈក${\color{red}\text{ម្ពា}}$ធិការដឹក${\color{red}\text{ឆាំ}}$ | និងកែសម្រួលសមាសភាពរាជ${\color{red}\text{ន្ឋា}}$ភិបាលនៃ${\color{red}\text{ទ្រះ}}$រាជាណាចក្រកម្ពុជា | ${\color{red}\text{ទូ}}$បនាយករដ្ឋមន្ត្រី | 180818125 |
