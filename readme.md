...
| **SeqSE-CRNN-Tr** | អគ្គលេខះ$\textcolor{red}{\text{ទិកា}}$ដ្ឋាន$\textcolor{red}{\text{ឧកណះ}}$ក$\textcolor{red}{\text{ម្ពា}}$ធិការ$\textcolor{red}{\text{ដើ}}$កនាំ | និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល$\textcolor{red}{\text{នៃ}}$ព្រះរាជាណាចក្រកម្ពុជា | ឧបនាយក$\textcolor{red}{\text{រដ្ឋ}}$មន្ត្រី | $180818{\color{red}18}125$ |
...
| **ResNet-Tr** | $\textcolor{red}{\text{ភ្លេ}}$ល$\textcolor{red}{\text{ខះ}}$ធិការដ្ឋាន$\textcolor{red}{\#}$ណៈក$\textcolor{red}{\text{ម្ព}}$ដិការដឹកនាំ | និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល$\textcolor{red}{\text{នៃ}}$ព្រះរាជាណាចក្រកម្ពុជា | ឧបនាយករដ្ឋម$\textcolor{red}{\text{ន្តី}}$ | $18{\color{red}0}818125$ |
